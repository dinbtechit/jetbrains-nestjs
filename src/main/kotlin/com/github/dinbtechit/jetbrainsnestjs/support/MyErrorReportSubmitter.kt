package com.github.dinbtechit.jetbrainsnestjs.support
...
class MyErrorReportSubmitter: ErrorReportSubmitter() {
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/dinbtechit/jetbrains-nestjs/issues/new")
